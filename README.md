...
[![Version](https://img.shields.io/badge/version-2.0.5-c65f31.svg)](https://github.com/heng1234/claude-web)
...
> 当前文档对应 `2.0.5`。历史变更见 [CHANGELOG.md](CHANGELOG.md)，Authenticator 配置见 [TOTP_SETUP.md](TOTP_SETUP.md)。
